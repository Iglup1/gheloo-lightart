...
- The tile icon is Kenjy's PixelArt logo from `shared-context/assets/icons/2026-07-01-pixelart-logo.png`, embedded in `pixelart-lightart.js` as a cropped 64x96 portrait PNG data URI.
- Gheloo renders hub icons at `20px x 30px`, so keep the embedded icon portrait-shaped instead of square.
